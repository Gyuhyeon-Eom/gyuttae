const CACHE='gyeote-shell-v11';
const FILES=['/','/theme.css','/app.css','/home.css','/app.js','/features.js','/manifest.webmanifest','/icons/icon-192.png','/icons/icon-512.png','/icons/icon.svg'];
